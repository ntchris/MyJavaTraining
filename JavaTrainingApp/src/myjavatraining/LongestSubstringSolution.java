...
public class LongestSubstringSolution {
   ...
   static public void test() {
      ...
      String testStringpw = "pwwkew";
      int answerpw = lengthOfLongestSubstringHashMap(testStringpw);
      System.out.println("Test string is " + testStringpw + " answer is " + answerpw);
      assertEquals(3, answerpw);
